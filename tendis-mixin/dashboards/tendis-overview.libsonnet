...
+ g.dashboard.withPanels([
  ...
  g.panel.row.new('Cluster Overview') + { gridPos: { h: 1, w: 24, x: 0, y: 0 }, collapsed: false },

  // Panel 1: Instance Status
  g.panel.stat.new('Instance Status') + {
    description: 'Tendis instance status', datasource: 'Prometheus', gridPos: { h: 4, w: 4, x: 0, y: 1 },
  ...
  g.panel.stat.new('Cluster State') + {
    description: 'Cluster state', datasource: 'Prometheus', gridPos: { h: 4, w: 4, x: 4, y: 1 },
  ...
  g.panel.stat.new('Replication Role') + {
    description: 'Replication role', datasource: 'Prometheus', gridPos: { h: 4, w: 4, x: 8, y: 1 },
    targets: [
  ...
  g.panel.stat.new('Connected Clients') + {
    description: 'Connected clients', datasource: 'Prometheus', gridPos: { h: 4, w: 4, x: 12, y: 1 },
  ...
  g.panel.stat.new('Cluster Nodes') + {
    description: 'Cluster nodes', datasource: 'Prometheus', gridPos: { h: 4, w: 4, x: 16, y: 1 },
  ...
  g.panel.stat.new('Cluster Size') + {
    description: 'Cluster size', datasource: 'Prometheus', gridPos: { h: 4, w: 4, x: 20, y: 1 },
  ...
  g.panel.row.new('Performance Metrics') + { gridPos: { h: 1, w: 24, x: 0, y: 5 }, collapsed: false },

  // Panel 7: QPS
  g.panel.timeSeries.new('QPS') + {
    description: 'Instantaneous operations per second', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 6 },
    targets: [
  ...
  g.panel.timeSeries.new('Network I/O') + {
    description: 'Network input/output rate', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 6 },
    targets: [
  ...
  g.panel.timeSeries.new('Keyspace Hit Rate') + {
    description: 'Keyspace hit rate', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 14 },
  ...
  g.panel.timeSeries.new('Average Command Latency') + {
    description: 'Command execution time', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 14 },
  ...
  g.panel.barGauge.new('Top 10 Commands by QPS') + {
    description: 'Top commands by call count', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 22 },
  ...
  g.panel.barGauge.new('Top 10 Commands by Latency') + {
    description: 'Top commands by latency', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 22 },
  ...
  g.panel.row.new('RocksDB Binlog') + { gridPos: { h: 1, w: 24, x: 0, y: 30 }, collapsed: false },

  // Panel 13: Binlog Remain
  g.panel.timeSeries.new('Binlog Remain') + {
    description: 'Binlog remain count', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 31 },
  ...
  // Panel 14: Binlog Watermarks
  g.panel.timeSeries.new('Binlog Watermarks') + {
    description: 'Binlog high/low watermarks', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 31 },
    targets: [
  ...
  g.panel.row.new('RocksDB Level Stats') + { gridPos: { h: 1, w: 24, x: 0, y: 39 }, collapsed: false },

  // Panel 15: Level Files Count
  g.panel.timeSeries.new('Level Files Count') + {
    description: 'RocksDB level file count', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 40 },
  ...
  g.panel.timeSeries.new('Level Size') + {
    description: 'RocksDB level size', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 40 },
  ...
  // Panel 17: Level Entries Count
  g.panel.timeSeries.new('Level Entries Count') + {
    description: 'RocksDB level entries', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 48 },
    targets: [target('sum by(instance, level) (tendis_levelstats_num_entries)', '{{instance}} - {{level}}')],
    options: { legend: { displayMode: 'table', placement: 'bottom', calcs: ['last'] } },
    fieldConfig: { defaults: { color: { mode: 'palette-classic' }, unit: 'short' } }
  },

  // Panel 18: Total SST Files Size
  g.panel.stat.new('Total SST Files Size') + {
    description: 'RocksDB total SST files size', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 48 },
  ...
  g.panel.row.new('RocksDB Cache & Performance') + { gridPos: { h: 1, w: 24, x: 0, y: 56 }, collapsed: false },

  // Panel 19: Block Cache
  g.panel.timeSeries.new('Block Cache') + {
    description: 'Block cache usage', datasource: 'Prometheus', gridPos: { h: 8, w: 8, x: 0, y: 57 },
    targets: [
  ...
  g.panel.timeSeries.new('Row Cache') + {
    description: 'Row cache usage', datasource: 'Prometheus', gridPos: { h: 8, w: 8, x: 8, y: 57 },
    targets: [
  ...
  // Panel 21: Block Cache Hit Rate
  g.panel.timeSeries.new('Block Cache Hit Rate') + {
    description: 'Block cache hit rate', datasource: 'Prometheus', gridPos: { h: 8, w: 8, x: 16, y: 57 },
    targets: [
  ...
  // Panel 22: RocksDB I/O
  g.panel.timeSeries.new('RocksDB I/O') + {
    description: 'RocksDB read/write bytes', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 65 },
    targets: [
  ...
  // Panel 23: RocksDB Compaction I/O
  g.panel.timeSeries.new('RocksDB Compaction I/O') + {
    description: 'RocksDB compaction bytes', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 65 },
    targets: [
  ...
  // Panel 24: Bloom Filter Effectiveness
  g.panel.timeSeries.new('Bloom Filter Effectiveness') + {
    description: 'Bloom filter effectiveness', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 73 },
  ...
  // Panel 25: Estimated Keys
  g.panel.stat.new('Estimated Keys') + {
    description: 'Estimate keys count', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 73 },
  ...
  // Row 6: Keyspace & TTL
  g.panel.row.new('Keyspace & TTL') + { gridPos: { h: 1, w: 24, x: 0, y: 81 }, collapsed: false },

  // Panel 26: DB Keys
  g.panel.timeSeries.new('DB Keys') + {
    description: 'Keys in database', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 82 },
  ...
  g.panel.timeSeries.new('DB Expires') + {
    description: 'Expiring keys in database', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 82 },
    targets: [target('sum by(instance, db) (tendis_db_expires)', '{{instance}} - {{db}}')],
    options: { legend: { displayMode: 'table', placement: 'bottom', calcs: ['last', 'max'] } },
    fieldConfig: { defaults: { color: { mode: 'palette-classic' }, unit: 'short' } }
  },

  // Panel 28: Average TTL
  g.panel.timeSeries.new('Average TTL') + {
    description: 'Average TTL', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 90 },
    targets: [target('avg by(instance, db) (tendis_db_avg_ttl_seconds)', '{{instance}} - {{db}}')],
    options: { legend: { displayMode: 'table', placement: 'bottom', calcs: ['last', 'mean'] } },
    fieldConfig: { defaults: { color: { mode: 'palette-classic' }, unit: 's' } }
  },

  // Panel 29: Expired Keys Rate
  g.panel.timeSeries.new('Expired Keys Rate') + {
    description: 'Expired keys count', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 90 },
  ...
  // Row 7: Replication
  g.panel.row.new('Replication') + { gridPos: { h: 1, w: 24, x: 0, y: 98 }, collapsed: false },

  // Panel 30: Replication Offset Lag (Master)
  g.panel.timeSeries.new('Replication Offset Lag (Master)') + {
    description: 'Replication offset lag (master)', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 99 },
    targets: [target('tendis_info_master_repl_offset - max by(instance) (tendis_slave_offset)', 'Offset Lag - {{instance}}')],
    options: { legend: { displayMode: 'table', placement: 'bottom', calcs: ['last', 'max', 'mean'] } },
    fieldConfig: { defaults: { color: { mode: 'palette-classic' }, unit: 'short' } }
  },

  // Panel 31: Replication Lag (Slave)
  g.panel.timeSeries.new('Replication Lag (Slave)') + {
    description: 'Replication lag in seconds (slave)', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 99 },
    targets: [target('tendis_slave_lag_seconds', '{{instance}} - {{slave_id}}')],
    options: { legend: { displayMode: 'table', placement: 'bottom', calcs: ['last', 'max', 'mean'] } },
    fieldConfig: { defaults: { color: { mode: 'palette-classic' }, unit: 's' } }
  },

  // Panel 32: Slave Binlog Lag
  g.panel.timeSeries.new('Slave Binlog Lag') + {
    description: 'Slave binlog lag', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 107 },
    targets: [target('tendis_slave_binlog_lag_seconds', '{{instance}} - {{slave_id}}')],
    options: { legend: { displayMode: 'table', placement: 'bottom', calcs: ['last', 'max', 'mean'] } },
    fieldConfig: { defaults: { color: { mode: 'palette-classic' }, unit: 's' } }
  },

  // Panel 33: Connected Slaves
  g.panel.stat.new('Connected Slaves') + {
    description: 'Connected slaves (master)', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 107 },
    targets: [target('tendis_info_connected_slaves', '{{instance}}')],
    options: { orientation: 'auto', reduceOptions: { values: false, calcs: ['lastNotNull'], fields: '' } },
    fieldConfig: { defaults: { color: { mode: 'thresholds' }, unit: 'short' } }
  },

  // Panel 34: Master Last I/O (Slave View)
  g.panel.timeSeries.new('Master Last I/O (Slave View)') + {
    description: 'Master last I/O seconds ago (slave)', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 115 },
    targets: [target('tendis_info_master_last_io_seconds_ago', '{{instance}}')],
    options: { legend: { displayMode: 'table', placement: 'bottom', calcs: ['last', 'max'] } },
    fieldConfig: { defaults: { color: { mode: 'palette-classic' }, unit: 's' } }
  },

  // Panel 35: Slave State
  g.panel.stat.new('Slave State') + {
    description: 'Slave state', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 115 },
  ...
  g.panel.row.new('Memory & Resources') + { gridPos: { h: 1, w: 24, x: 0, y: 123 }, collapsed: false },

  // Panel 36: Resident Memory
  g.panel.timeSeries.new('Resident Memory') + {
    description: 'Process resident memory', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 124 },
    targets: [
  ...
  // Panel 37: Virtual Memory
  g.panel.timeSeries.new('Virtual Memory') + {
    description: 'Process virtual memory', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 124 },
    targets: [
  ...
  // Panel 38: RocksDB Memory
  g.panel.timeSeries.new('RocksDB Memory') + {
    description: 'RocksDB total memory', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 132 },
    targets: [target('tendis_info_rocksdb_total_memory', '{{instance}}')],
    options: { legend: { displayMode: 'table', placement: 'bottom', calcs: ['last', 'max', 'mean'] } },
    fieldConfig: { defaults: { color: { mode: 'palette-classic' }, unit: 'bytes' } }
  },

  // Panel 39: RocksDB Memtables
  g.panel.timeSeries.new('RocksDB Memtables') + {
    description: 'RocksDB memtables size', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 132 },
  ...
  g.panel.row.new('CPU & Process Stats') + { gridPos: { h: 1, w: 24, x: 0, y: 140 }, collapsed: false },

  // Panel 40: CPU Usage
  g.panel.timeSeries.new('CPU Usage') + {
    description: 'CPU usage', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 141 },
  ...
  // Panel 41: Process Threads
  g.panel.timeSeries.new('Process Threads') + {
    description: 'Process threads', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 141 },
  ...
  // Panel 42: Context Switches Rate
  g.panel.timeSeries.new('Context Switches Rate') + {
    description: 'Context switches', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 149 },
    targets: [
  ...
  // Panel 43: Page Faults Rate
  g.panel.timeSeries.new('Page Faults Rate') + {
    description: 'Page faults', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 149 },
    targets: [
  ...
  // Row 10: Disk I/O
  g.panel.row.new('Disk I/O') + { gridPos: { h: 1, w: 24, x: 0, y: 157 }, collapsed: false },

  // Panel 44: Disk Read I/O
  g.panel.timeSeries.new('Disk Read I/O') + {
    description: 'Disk read I/O', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 158 },
    targets: [
  ...
  // Panel 45: Disk Write I/O
  g.panel.timeSeries.new('Disk Write I/O') + {
    description: 'Disk write I/O', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 158 },
    targets: [
  ...
  // Panel 46: I/O Operations Rate
  g.panel.timeSeries.new('I/O Operations Rate') + {
    description: 'I/O operations', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 0, y: 166 },
    targets: [
  ...
  // Panel 47: Block I/O Delay Rate
  g.panel.timeSeries.new('Block I/O Delay Rate') + {
    description: 'Block I/O delay', datasource: 'Prometheus', gridPos: { h: 8, w: 12, x: 12, y: 166 },
  ...
  g.panel.row.new('System & Cluster Health') + { gridPos: { h: 1, w: 24, x: 0, y: 174 }, collapsed: false },

  // Panel 48: Uptime
  g.panel.stat.new('Uptime') + {
    description: 'Uptime', datasource: 'Prometheus', gridPos: { h: 6, w: 8, x: 0, y: 175 },
    targets: [target('tendis_info_uptime_in_seconds', '{{instance}}')],
    options: { orientation: 'auto', reduceOptions: { values: false, calcs: ['lastNotNull'], fields: '' } },
    fieldConfig: { defaults: { color: { mode: 'thresholds' }, unit: 's' } }
  },

  // Panel 49: Total Connections
  g.panel.stat.new('Total Connections') + {
    description: 'Total connections received', datasource: 'Prometheus', gridPos: { h: 6, w: 8, x: 8, y: 175 },
    targets: [target('tendis_info_total_connections_received', '{{instance}}')],
    options: { orientation: 'auto', reduceOptions: { values: false, calcs: ['lastNotNull'], fields: '' } },
    fieldConfig: { defaults: { color: { mode: 'thresholds' }, unit: 'short' } }
  },

  // Panel 50: Rejected Connections
  g.panel.stat.new('Rejected Connections') + {
    description: 'Rejected connections', datasource: 'Prometheus', gridPos: { h: 6, w: 8, x: 16, y: 175 },
    targets: [target('tendis_info_rejected_connections', '{{instance}}')],
    options: { orientation: 'auto', reduceOptions: { values: false, calcs: ['lastNotNull'], fields: '' } },
    fieldConfig: { defaults: { color: { mode: 'thresholds' }, unit: 'short' } }
  },

  // Panel 51: Compaction Status
  g.panel.stat.new('Compaction Status') + {
    description: 'Compaction status', datasource: 'Prometheus', gridPos: { h: 6, w: 8, x: 0, y: 181 },
  ...
  // Panel 52: Time Since Last Compaction
  g.panel.stat.new('Time Since Last Compaction') + {
    description: 'Time since last compaction', datasource: 'Prometheus', gridPos: { h: 6, w: 8, x: 8, y: 181 },
    targets: [target('tendis_info_time_since_lastest_compaction', '{{instance}}')],
    options: { orientation: 'auto', reduceOptions: { values: false, calcs: ['lastNotNull'], fields: '' } },
    fieldConfig: { defaults: { color: { mode: 'thresholds' }, unit: 's' } }
  },

  // Panel 53: Pending Compaction
  g.panel.stat.new('Pending Compaction') + {
    description: 'Pending compaction bytes', datasource: 'Prometheus', gridPos: { h: 6, w: 8, x: 16, y: 181 },
    targets: [target('tendis_info_rocksdb_estimate_pending_compaction_bytes', '{{instance}}')],
    options: { orientation: 'auto', reduceOptions: { values: false, calcs: ['lastNotNull'], fields: '' } },
    fieldConfig: { defaults: { color: { mode: 'thresholds' }, unit: 'bytes' } }
  },

  // Panel 54: Cluster Slot Distribution
  g.panel.timeSeries.new('Cluster Slot Distribution') + {
    description: 'Cluster slot distribution', datasource: 'Prometheus', gridPos: { h: 8, w: 24, x: 0, y: 187 },
    targets: [
